...
describe Bus do
  ...
  # Iteration 3
  context 'Passengers Capacity' do
    it 'returns a count passengers' do
      bus = Bus.new('Mikes Awesome Bus', 4)
      bus.add_passenger('Mike')
      bus.add_passenger('Megan')
      bus.add_passenger('Tim')
    ...
    it 'returns bool to over_capacity?' do
      bus = Bus.new('Mikes Awesome Bus', 4)
      bus.add_passenger('Mike')
      bus.add_passenger('Megan')
      bus.add_passenger('Tim')
  ...
  context 'Moving Passengers' do
    it 'can kick out passengers' do
      ...
      expect(bus.number_of_passengers).to eq(6)
